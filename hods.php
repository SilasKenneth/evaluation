...
<div class="col-md-8 offset-2 mt-4">
    ...
    <div class="col-mod-4 offset-2">
        ...
        <p class="text-center"><small class="font-weight-light text-center font-italic">There are currently no <strong>HODs</strong> available</small></p>
        <?php
        if(is_admin()){
            ?>
            <a class="btn btn-primary btn-sm offset-5" href="addhod.php">Add some <i class="fa fa-plus-circle"></i> </a>
        <?php } }?>
    </div>
</div>
<?php
